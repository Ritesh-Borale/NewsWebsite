      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link to="https://flowbite.com" className="flex items-center">
            ...
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">NewsWeb</span>
          </Link>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:p-0  ${
                      isActive ? "text-white bg-primary-700 lg:text-primary-700" : "text-gray-700"
                    }`
                  }
                >
                  World
